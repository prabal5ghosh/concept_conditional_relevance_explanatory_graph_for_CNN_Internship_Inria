...
image = Image.open("images/dog4.jpg")

sample = transform(image).unsqueeze(0).to(device)

import sys

output_file_path = '/home/prghosh/output_image/image_512/dog12_inference_1/output_file_dog12_inference_1.txt'
...
with open(output_file_path, 'w') as file:
    ...
    image_to_save.save("/home/prghosh/output_image/image_512/dog12_inference_1/sample_224*224_dog12.jpg")  # Change the file path and name as needed
    ...
    # Save the image to a file
    modified_image.save( "/home/prghosh/output_image/image_512/dog12_inference_1/masked_image_dog12.jpg")  # Change the file name and format as needed

    # image_to_save.save("modified_image.jpg")  # Change the file path and name as needed

    print("masked_image_dog12.jpg saved successfully!")
    ...
    save_directory = "/home/prghosh/output_image/image_512/dog12_inference_1/"  # Update this to your desired directory

    if not os.path.exists(save_directory):
        os.makedirs(save_directory)

    file_name = "final_image_heat_map_dog12.jpg"
    ...
    file_name = "complement_final_image_heat_map_dog12.jpg"
